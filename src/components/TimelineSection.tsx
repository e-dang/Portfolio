...
export const TimelineSection: React.FC<TimelineSectionProps> = ({idx, dateRange, children}) => {
  return (
    <>
      ...
      <div
        className={`relative col-start-2 row-start-${idx} before:absolute before:-left-1 before:top-[0.3rem] before:h-4 before:w-4 before:rounded-full before:border-[0.2rem] before:border-violet-500 before:content-['']`}
      >
        <div className="absolute left-1 top-[2.3rem] h-[0.2rem] w-[calc(100%+0.8rem)] rotate-[30deg] bg-violet-500 " />
      </div>
